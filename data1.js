// const data=[];
// function add_data(id1,name1,link1,thumbnail1,lead_star1){
//   data.push({
//     name:name1,
//     link:link1,
//     thumbnail: thumbnail1,
//     lead_star: lead_star1 ,
//     id:id1,    
  
//   })
// }
// let filte_map=new Set(
//   [
// "8agZVHpNZ0o",
// "8agZVHpNZ0o",
// "ULEQb_l-N08",
...
// ]
// )
// let arr_of_id=Array.from(filte_map)
// arr_of_id.map((data)=>{
// add_data(data)
// })
...
;
  ...
  // // fetch('https://online-movie-database.p.rapidapi.com/title/find?q=tt15398776', options)
...
//     method: 'GET',
//     headers: {
//       'X-RapidAPI-Key': '8d8bc26d55msh99a1cd80ac140bdp1cdee4jsn850e400cfda3',
//       'X-RapidAPI-Host': 'online-movie-database.p.rapidapi.com'
//     }
//   };
  
//   // fetch(`https://online-movie-database.p.rapidapi.com/title/find?q=${arr[i]}`, options)
//     .then(response => response.json())
//     .then(response => {console.log(response)
